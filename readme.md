...
class student: identity : student state : roles, responsibilities, duties behavior: enforce rules, communicate, coordinate, assist, resolve

class car: Identity : car State : brand, color, type, model year, engine bahavior : moves, transports, accelerate,reverse
